...
var MessageController = /** @class */ (function () {
    ...
    MessageController.prototype.get = function (search, type, isId) {
                ...
                switch (_b.label) {
                    case 0:
                        if (!payload.sender || !payload.conversationId) {
                            throw new errors_1.BadRequestError("Validate fields sender and conversationId", {
    ...
    MessageController.prototype.returnGetResponse = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
