...
var ConversationRouter = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.conversationController.get(search, type)];
                    case 1:
                        contacts = _b.sent();
                        contacts === null
    ...
    ConversationRouter.prototype.getBy = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, userId, maulanaId, contact, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.query, userId = _a.userId, maulanaId = _a.maulanaId;
                        return [4 /*yield*/, this.conversationController.getBy(userId, maulanaId)];
                    case 1:
                        contact = _b.sent();
                        contact === null
                            ? res.status(404).send(new errors_1.NotFoundError("No record found", {
    ...
    ConversationRouter.prototype.routes = function () {
        var _this = this;
        this.router.route("/get").get(middleware_1.sanitizeQuery, middleware_1.trimQueryWhiteSpace, middleware_1.authentication, middleware_1.authorization([enums_1.Role.User, enums_1.Role.Admin]), async_wrap_1.asyncWrap(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.router.route("/get-by").get(middleware_1.sanitizeQuery, middleware_1.trimQueryWhiteSpace, middleware_1.authentication, middleware_1.authorization([enums_1.Role.User, enums_1.Role.Admin]), async_wrap_1.asyncWrap(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.router.route("/create").post(middleware_1.sanitizeBody, middleware_1.trimBodyWhiteSpace, middleware_1.authentication, middleware_1.authorization([enums_1.Role.User, enums_1.Role.Admin]), async_wrap_1.asyncWrap(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.router.route("/edit").post(middleware_1.sanitizeBody, middleware_1.trimBodyWhiteSpace, middleware_1.authentication, middleware_1.authorization([enums_1.Role.User, enums_1.Role.Admin]), async_wrap_1.asyncWrap(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        this.router.route("/delete").get(middleware_1.sanitizeQuery, middleware_1.trimQueryWhiteSpace, middleware_1.sanitizeBody, middleware_1.trimBodyWhiteSpace, middleware_1.authentication, middleware_1.authorization([enums_1.Role.User, enums_1.Role.Admin]), async_wrap_1.asyncWrap(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
